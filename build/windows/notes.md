...
It sends nothing off the machine, listens on localhost only, installs no service and asks for no account. Reaching it from elsewhere is a transport you put in front of it, and every request still needs the token.
