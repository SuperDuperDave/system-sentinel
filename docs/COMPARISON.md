...
| **Decodes hardware-error records** | Yes: WHEA-Logger records with their binary payload decoded beside them | not checked | not checked | Reads crash dumps, a different artifact | Not mentioned in the listing read; not checked |
