...
INSTRUCTIONS = (
    ...
    "To verify a Signals lead, take its cited reading with the scope in method.readings[].params; "
    "a new take is a new observation, so compare asked_at. Before stating a cause, inspect that reading's raw evidence. "
