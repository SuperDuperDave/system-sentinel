        ...
        RouteTool(
            ...
            "if you supplied an envelope, retry with that original envelope.",
            {
                ...
                "properties": {
                    ...
                    "verbosity": {"type": "string", "enum": ["summary", "full"], "description": "Defaults to a derived summary for whole crash, faults, storms and whea_reports readings, or a bounded row summary for events, record and whea over 100 rows; full for selections and other readings. Can be changed later."},
